...
class SystemMotors:
    ...
    def setTorque(self, torqArray):
        ...
        for i, torq in enumerate(torqArray):
            # NOTE: fixed from motorsArray[i].setTorque(torq) -- Motor
            # defines SetTorque (capital S), not setTorque; the original
            # lowercase call raises AttributeError at runtime.
